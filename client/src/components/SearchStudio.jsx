...
const SearchStudio = () => {
    console.log("passage en search studio")
    ...
    return (
        ...
        {users.map((val)=>{
                    ...
                    return(
                        <>
                            <div className={((users.id == user.id && profilActif == undefined) || users.id == profilActif) ? "firstBlock" : "profilsBlock" }>

                                {(profilActif != undefined && users.id == profilActif) ? 
                                //premier resultat
