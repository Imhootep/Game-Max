                ...
                <>
                    <div className={((val._id === user._id && profilActif === undefined) || val._id === profilActif) ? "firstBlock" : "profilsBlock" }>
                        ...
                        <div className={"littleBlock border"+val.role.toLowerCase()}>
                            ...
                            <div className={"roleTitle "+val.role.toLowerCase()}>{val.role}</div>
                            ...
                            <div className="linksProfil">
                                ...
                                <a target="_blank" href={val.social.facebook}>
                                    <svg> <a target="_blank" href={val.social.facebook}><path d="M13.5 5.313q-1.125 0-1.781.375t-.844.938-.188 1.438v3.938H16l-.75 5.688h-4.563v14.313H4.812V17.69H-.001v-5.688h4.813v-4.5q0-3.563 2-5.531T12.125.002q2.688 0 4.375.25v5.063h-3z"></path></a></svg>
                                </a>
                                </div>
                                <div className="socialProfil">
